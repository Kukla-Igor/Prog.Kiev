                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <c:forEach items="${groups}" var="group">
                                        <li><a href="/deleteGroup/${group.id}">${group.name}</a></li>
                                    </c:forEach>
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Convert to: <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li><a href="/toJson">JSON</a></li>
                                    <li><a href="/toXML">XML</a></li>
                                </ul>
                            </li>
                        </ul>
